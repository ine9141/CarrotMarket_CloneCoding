...
public class coupon_adapter extends RecyclerView.Adapter<coupon_adapter.CustomViewHolder> {
    private ArrayList<cardview_item> items = new ArrayList<cardview_item>();
    private Context context;
    private int i;

    public coupon_adapter(ArrayList<cardview_item> item){
        items = item;
    }
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        coupon_adapter.CustomViewHolder holder = new coupon_adapter.CustomViewHolder(view);
